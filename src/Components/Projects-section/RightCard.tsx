...
function RightCard({ src, project }: { src: string, project: string }) {
    ...
    return (
        ...
        <div className="card-container  w-1/2 ">
            ...
            <div
                ...
                <h1 className="absolute text-[#CDEA68] right-1/16  -translate-y-[50%] -translate-x-[50%] top-1/2  z-[9] font-Founders flex overflow-hidden  text-5xl"
                >
